...
| Client state                 | Angular services + Signals                                                            | [Section 5.5](#55-state-management)                                                 |     | Spreadsheet rendering | Application-owned hybrid rendering with Canvas preferred for high-density surfaces | [Section 6](#6-spreadsheet-grid-and-interaction-architecture) |
